...
const navigation = ["Overview", "Data Status", "Dataset Quality", "Feature Status", "Backtests", "Market Replay", "Paper Trading", "Trades", "System Health", "Settings"] as const;
  ...
  return (
    <div style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "250px minmax(0, 1fr)" }}>
      ...
      <main style={{ padding: "28px clamp(22px,4vw,64px) 60px", overflow: "hidden" }}>
        ...
        {page === "Data Status" ? <DataStatus /> : page === "Dataset Quality" ? <DatasetQuality /> : page === "Feature Status" ? <FeatureStatus /> : (page === "Overview" || healthPage) ? <>
