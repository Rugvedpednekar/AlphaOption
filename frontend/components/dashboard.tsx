...
const navigation = ["Overview", "Backtests", "Market Replay", "Paper Trading", "Trades", "System Health", "Settings"] as const;
      ...
      <main style={{ padding: "28px clamp(22px,4vw,64px) 60px", overflow: "hidden" }}>
        ...
        {(page === "Overview" || healthPage) ? <>
          ...
          <section aria-label="System status" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(210px,1fr))", gap: 16 }}>
            ...
            <StatusCard label="Market data" value="Not configured" detail="Planned for Phase 8" icon={<WifiOff size={20} />} />
          ...
          <section style={{ marginTop: 24, padding: 22, background: "var(--panel)", border: "1px solid var(--line)", borderRadius: 18 }}><h2 style={{ marginTop: 0, fontSize: 17 }}>Environment note</h2><p style={{ color: "var(--muted)", lineHeight: 1.7, marginBottom: 0 }}>This foundation reports service and database health only. Market data, strategies, models, backtests, brokers, trades, positions, and performance metrics are intentionally absent.</p></section>
